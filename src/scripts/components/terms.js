...
const showTerms = (arr) => {
  ...
  <div class="card-body">
    ...
    ${term.user_id === term.uid ? `<i class="btn btn-danger fa fa-trash-alt" id="delete-term--${term.firebaseKey}"></i>
    <i class="btn btn-success far fa-edit" id="edit-term--${term.firebaseKey}"></i>` : `<i class="btn btn-success far fa-edit" id="copy-term--${term.firebaseKey}"></i>`}
  </div>
</div>`;
  });
