...
const addTermForm = (obj = {}) => {
  clearDom();
  const domString = `<form id="termForm">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <textarea cols="80" rows="3" required class="form-control" id="definition" aria-describedby="definition" placeholder="Enter definition" value="${obj.definition || ''}"></textarea>
  </div>
